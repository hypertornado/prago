...
class Popup {
    ...
    protected addButton(name: string, handler: any, style?: ButtonStyle): HTMLInputElement {
...
class Confirm extends Popup {
    ...
    constructor(title: string, handlerConfirm?: Function, handlerCancel?: Function, style?: ButtonStyle) {
        super(title);
        this.setCancelable();
        if (!style) {
