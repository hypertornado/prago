...
func initNotificationResource(resource *Resource) {
	...
	resource.Admin.AdminController.Get(resource.Admin.GetURL("_api/notifications"), func(request prago.Request) {
	...
	resource.Admin.AdminController.Delete(resource.Admin.GetURL("_api/notification/:uuid"), func(request prago.Request) {
